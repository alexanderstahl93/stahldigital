          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
              <div className="p-6 md:p-8">
                <div className="flex items-center mb-6">
                  <div className="w-16 h-16 bg-custom-blue rounded-lg flex items-center justify-center mr-4">
                    <span className="text-white font-bold text-xl">S&P</span>
                  </div>
                  <div>
                    <h3 className="text-xl md:text-2xl font-medium tracking-tight">Stahl & Partner</h3>
                    <p className="text-sm text-gray-500">Beratung & Consulting</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-custom-orange rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-medium text-gray-900 mb-1">Content Marketing</h4>
                      <p className="text-sm text-gray-600">
                        Autorität in der Branche durch 45 hochwertige Fachartikel und 12 Whitepaper.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-custom-orange rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-medium text-gray-900 mb-1">LinkedIn Ads</h4>
                      <p className="text-sm text-gray-600">
                        B2B-Lead-Generierung mit 6.8% Conversion-Rate und 45% niedrigeren Kosten.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-900 mb-1">Ergebnis</h4>
                      <p className="text-sm text-gray-600">
                        180% mehr qualifizierte B2B-Kontakte und 75% höhere Projektgewinnungsrate.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div>
                      <div className="text-2xl font-bold text-custom-blue">6.8%</div>
                      <div className="text-xs text-gray-600">Conversion</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-custom-blue">180%</div>
                      <div className="text-xs text-gray-600">Mehr Kontakte</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden">
              <div className="p-6 md:p-8">
                <div className="flex items-center mb-6">
                  ...
                  <div>
                    <h3 className="text-xl md:text-2xl font-medium tracking-tight">Umzug-Direkt</h3>
                    <p className="text-sm text-gray-500">Umzugsservice & Logistik</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-custom-orange rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-medium text-gray-900 mb-1">Google Ads Optimierung</h4>
                      <p className="text-sm text-gray-600">
                        Saisonal optimierte Kampagnen mit 320% höherer Conversion-Rate in Spitzenzeiten.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    <div className="w-2 h-2 bg-custom-orange rounded-full mt-2 flex-shrink-0"></div>
                    <div>
                      <h4 className="font-medium text-gray-900 mb-1">Remarketing</h4>
                      <p className="text-sm text-gray-600">
                        Personalisierte Remarketing-Strategien mit 85% höherer Wiederholungsrate.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-900 mb-1">Ergebnis</h4>
                      <p className="text-sm text-gray-600">
                        400% mehr Buchungen und 55% höhere durchschnittliche Auftragswerte.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div>
                      <div className="text-2xl font-bold text-custom-blue">320%</div>
                      <div className="text-xs text-gray-600">Conversion</div>
                    </div>
                    <div>
                      <div className="text-2xl font-bold text-custom-blue">400%</div>
                      <div className="text-xs text-gray-600">Mehr Buchungen</div>
                    </div>
                  </div>
                </div>
              </div>

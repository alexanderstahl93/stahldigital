...
export default function Cover() {
  return (
    <div className="relative min-h-screen overflow-hidden">
      ...
      {/* Die Garantie - Risikofreie Zusammenarbeit */}
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            ...
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
              Wir sind so überzeugt von unserem Ansatz, dass wir dir eine 
              risikofreie Zusammenarbeit garantieren.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <div className="relative inline-block">
                <div className="w-64 h-64 md:w-80 md:h-80 bg-gradient-to-br from-green-500 to-emerald-600 rounded-full mx-auto lg:mx-0 flex items-center justify-center shadow-2xl">
                  <div className="text-white text-center">
                    <svg className="w-24 h-24 md:w-32 md:h-32" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                    <div className="text-2xl md:text-3xl font-bold mt-4">Garantie</div>
                  </div>
                </div>
                <div className="absolute -top-4 -right-4 w-20 h-20 bg-custom-orange rounded-full flex items-center justify-center shadow-lg">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-6">
                  Wenn du in den ersten 30 Tagen nicht zufrieden bist, bekommst du dein Geld zurück. 
                  Punkt. Keine Fragen, keine Bedingungen.
                </p>
              </div>
              
              <div className="space-y-6">
                <div className="bg-green-50 border border-green-200 rounded-xl p-6">
                  <h5 className="font-semibold text-green-800 mb-3">Was wir garantieren</h5>
                  <div className="space-y-3">
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-green-700">Transparente Kommunikation</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-green-700">Messbare Ergebnisse</span>
                    </div>
                    <div className="flex items-center space-x-3">
                      <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                      <span className="text-green-700">Professioneller Service</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200 text-center">
                    <div className="text-2xl font-bold text-custom-blue mb-2">0€</div>
                    <div className="text-sm text-gray-600">Setup-Gebühren</div>
                  </div>
                  <div className="bg-white rounded-xl p-4 shadow-sm border border-gray-200 text-center">
                    <div className="text-2xl font-bold text-custom-orange mb-2">Monatlich</div>
                    <div className="text-sm text-gray-600">Kündbar</div>
                  </div>
                </div>
                
                <div className="bg-gradient-to-r from-custom-blue to-custom-orange rounded-xl p-6 text-white">
                  <h5 className="font-semibold mb-3">Warum wir das können</h5>
                  <p className="text-sm opacity-90">
                    Weil wir überzeugt sind, dass unser Ansatz funktioniert. 
                    Wir haben es selbst erlebt und für andere bewiesen. 
                    Wenn du nicht zufrieden bist, haben wir etwas falsch gemacht.
                  </p>
                </div>
              </div>
              ...
              <div className="text-center lg:text-left">
                <a 
                  ...
                  className="inline-flex items-center px-8 py-4 bg-green-600 text-white font-semibold rounded-xl hover:bg-green-700 transition-colors duration-200 shadow-lg"
                >
